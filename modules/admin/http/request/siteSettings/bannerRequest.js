...
const validationRequestPost = [
  ...
  body("desktop_media_path").notEmpty().withMessage("Desktop media is required").isString().withMessage("Desktop media path must be a string"),
  body("mobile_media_path").notEmpty().withMessage("Mobile media is required").isString().withMessage("Mobile media path must be a string"),
