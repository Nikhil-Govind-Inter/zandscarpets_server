...
const validationRequestPost = [
  ...
  body('name_ar').notEmpty().withMessage('Name (Arabic) is required').isString().withMessage('Name (Arabic) must be a string'),
  body('designation').optional().isString().withMessage('Designation must be a string'),
  body('designation_ar').optional().isString().withMessage('Designation (Arabic) must be a string'),
  body('message').notEmpty().withMessage('Message is required').isString().withMessage('Message must be a string'),
  body('message_ar').notEmpty().withMessage('Message (Arabic) is required').isString().withMessage('Message (Arabic) must be a string'),
