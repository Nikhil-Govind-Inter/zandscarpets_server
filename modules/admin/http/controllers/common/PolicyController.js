...
const { validationRequestPost, validateId } = require("../../request/common/PolicyRequest");
...
class PolicyController {
    ...
    static async store(req, res) {
        ...
        try {
            const fileFields = ["banner_media_desktop_path","banner_media_mobile_path"];
