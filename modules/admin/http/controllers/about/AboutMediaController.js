...
const { validationRequestPost, validateId } = require("../../request/about/AboutMediaRequest");
const { handleFileUploadStore, handleFileUploadUpdate } = require('../../middleware/multerMiddleware');
const { paginate } = require('../../traits/datatablePaginationHelper');


const DataModel = models.AboutMedia;
...
class HomeBannerController {
    ...
    static async store(req, res) {
        ...
        try {
            const fileFields = ["thumbnail","media_desktop_path","media_mobile_path"];
