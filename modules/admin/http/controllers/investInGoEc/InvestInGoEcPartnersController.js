...
const {
  ...
  validateId,
} = require("../../request/investInGoEc/InvestInGoEcPartnersRequest");
const {
...
const DataModel = models.InvestInGoEcPartners;

class InvestInGoEcPartnersController {
...
module.exports = InvestInGoEcPartnersController;
